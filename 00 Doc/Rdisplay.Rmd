...
**Analysis**: Expected alertness level to be higher for straight through schedule workers, but data showed no strong relation between two factors
...
**Analysis**: No strong relation between sleep quality and length to job length. 
...
**Analysis**: Expected to see job security stress to go down as total years worked went up, but did not see this  
